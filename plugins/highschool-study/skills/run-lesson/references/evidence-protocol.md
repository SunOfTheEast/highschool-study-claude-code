...
Use active Trace as classroom evidence.

- Freeze the student's mathematical claims before assessment. Tutor-generated work cannot upgrade the same attempt.
...
- Missing, failed or conflicting evidence remains unresolved. Do not convert it into attainment.

Tool schemas own parameter names and validation. This reference owns the evidence meaning.
