...
4. Show the proposed Markdown diff in student language. Create or edit Roadmap/Plan files only after the student approves it. Any later reordering is student-approved reordering: preserve the previous Change Log entry, reason, and affected dependencies.
