...
- Create: `apps/pi-teaching-web/tests/fixtures/domain-integrity-learning-set/graph/vocabulary.yaml`
- Create: `apps/pi-teaching-web/tests/fixtures/domain-integrity-learning-set/memory/*.md`

**Interfaces:**

- Consumes: the current committed domain-integrity Roadmap, Plan, Lessons, four aliased cards, canonical method vocabulary, and three memory files.
...
```bash
mkdir -p apps/pi-teaching-web/tests/fixtures/domain-integrity-learning-set/{plans,lessons,cards/derivative,graph,memory}
...
cp examples/derivative-demo/learning-set/graph/vocabulary.yaml \
  apps/pi-teaching-web/tests/fixtures/domain-integrity-learning-set/graph/vocabulary.yaml
...
- no public problem card, public graph, material, persona, or confirmed profile appears in the diff;
