...
test('formats stable Material locators for humans without hiding the canonical value', () => {
...
test('starts a Material page from its suggested locator and keeps advanced input secondary', () => {
  ...
  expect(markup).toContain('page-0062');
  expect(markup).toContain('高级定位');
  expect(markup).not.toContain('value="page-0062"');
});
