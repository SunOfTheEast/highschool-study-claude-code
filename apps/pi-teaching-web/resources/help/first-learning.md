...
如果一时不知道怎么开口，空对话里也会给出几句普通的起点。你可以让老师帮你定位真正卡住的
一步，把眼前内容和学过的东西连起来，反驳你的想法，比较两个概念，或查找相关研究。点击只会
把这句话放进输入框；你可以继续改，确认后再自己发送。

## 让讨论留下来

你想把讨论中的内容留下来，或者老师提出一份具体草稿时，界面会先完整显示你以后能看到的
内容。你可以直接在对话里纠正；确认最新草稿后可以：
